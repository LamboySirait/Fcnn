...
# Class Config for setting parameters
class Config:
    def __init__(self):
        self.verbose = True
        self.network = 'vgg'
...
def mainf(image_save_path):
    ...
    base_path = 'C:\\Users\\Personal\\TA_20\\Test epoch'
    ...
    for idx, img_name in enumerate(imgs_path):
        ...
        plt.imsave('C:/Users/Personal/TA_20/fcnn/Test epoch/Faster-R-CNN-model-deployment-using-flask-on-local-host-master/uploads/image.png', img)
        letters = string.ascii_lowercase
        image_name = ''.join(random.choice(letters) for i in range(6))
        plt.imsave('predictions' + image_name + '.png', img)
        im_path = "C:\\Users\\Personal\\TA_20\\fcnn\\Test epoch\\Faster-R-CNN-model-deployment-using-flask-on-local-host-master\\uploads"
        im_name = "test.png"
